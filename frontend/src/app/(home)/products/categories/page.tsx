        ...
        <div>
            <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p className="text-sm text-dark-6">Manage your product categories</p>
                </div>
                <Link
            ...
            <div className="rounded-[10px] bg-white shadow-1 dark:bg-gray-dark">
                {loading ? (
                    ...
                    <div className="py-20 text-center">
                        ...
                        <p className="text-dark-6">No categories found</p>
                        <Link href="/products/categories/new" className="mt-4 inline-flex items-center gap-2 text-primary hover:underline">
